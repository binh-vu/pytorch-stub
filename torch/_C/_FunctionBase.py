...
class _FunctionBase(object):
    ...
    num_inputs = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    num_outputs = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    previous_functions = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
